        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <Link
              ...
              className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-5 py-3 text-sm font-semibold text-muted-foreground hover:text-foreground hover:bg-muted/60 transition-all -mb-[3px] whitespace-nowrap shrink-0"
              activeProps={{
                className:
                  'flex items-center gap-1.5 sm:gap-2 px-3 sm:px-5 py-3 text-sm font-black !text-white !bg-foreground/80 hover:!text-white hover:!bg-foreground/80 -mb-[3px] whitespace-nowrap shrink-0',
              }}
            >
